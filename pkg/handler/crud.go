...
import (
	...
	"github.com/foxdalas/flagr/swagger_gen/restapi/operations/constraint"
	...
	"github.com/foxdalas/flagr/swagger_gen/restapi/operations/tag"
...
func (c *crud) PutFlag(params flag.PutFlagParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest), notification.OperationUpdate, notification.ComponentFlag, util.SafeUint(params.FlagID), f.Key)
	return resp
}
...
func (c *crud) RestoreFlag(params flag.RestoreFlagParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest), notification.OperationRestore, notification.ComponentFlag, util.SafeUint(params.FlagID), f.Key)
	return resp
}
...
func (c *crud) DeleteFlag(params flag.DeleteFlagParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest), notification.OperationDelete, notification.ComponentFlag, util.SafeUint(params.FlagID), f.Key)
...
func (c *crud) DeleteTag(params tag.DeleteTagParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest), notification.OperationDelete, notification.ComponentTag, uint(params.TagID), "")
...
func (c *crud) CreateTag(params tag.CreateTagParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest), notification.OperationCreate, notification.ComponentTag, t.ID, t.Value)
	return resp
}
...
func (c *crud) CreateSegment(params segment.CreateSegmentParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest), notification.OperationCreate, notification.ComponentSegment, s.ID, "")
	return resp
}
...
func (c *crud) PutSegment(params segment.PutSegmentParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest), notification.OperationUpdate, notification.ComponentSegment, util.SafeUint(params.SegmentID), "")
	return resp
}
...
func (c *crud) PutSegmentsReorder(params segment.PutSegmentsReorderParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest), notification.OperationUpdate, notification.ComponentSegment, 0, "")
...
func (c *crud) DeleteSegment(params segment.DeleteSegmentParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest), notification.OperationDelete, notification.ComponentSegment, util.SafeUint(params.SegmentID), "")
...
func (c *crud) CreateConstraint(params constraint.CreateConstraintParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest), notification.OperationCreate, notification.ComponentConstraint, cons.ID, "")
	return resp
}
...
func (c *crud) PutConstraint(params constraint.PutConstraintParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest), notification.OperationUpdate, notification.ComponentConstraint, util.SafeUint(params.ConstraintID), "")
	return resp
}
...
func (c *crud) DeleteConstraint(params constraint.DeleteConstraintParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest), notification.OperationDelete, notification.ComponentConstraint, util.SafeUint(params.ConstraintID), "")
	return resp
}
...
func (c *crud) PutDistributions(params distribution.PutDistributionsParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest), notification.OperationUpdate, notification.ComponentDistribution, 0, "")
	return resp
}
...
func (c *crud) CreateVariant(params variant.CreateVariantParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest), notification.OperationCreate, notification.ComponentVariant, v.ID, v.Key)
	return resp
}
...
func (c *crud) PutVariant(params variant.PutVariantParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest), notification.OperationUpdate, notification.ComponentVariant, util.SafeUint(params.VariantID), v.Key)
	return resp
}
...
func (c *crud) DeleteVariant(params variant.DeleteVariantParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest), notification.OperationDelete, notification.ComponentVariant, util.SafeUint(params.VariantID), "")
