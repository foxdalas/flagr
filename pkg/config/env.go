...
var Config = struct {
	...
	*/
	...
	RecorderKafkaVersion             string        `env:"FLAGR_RECORDER_KAFKA_VERSION" envDefault:"2.1.0"`
	...
	RecorderKafkaWorkerCount         int           `env:"FLAGR_RECORDER_KAFKA_WORKER_COUNT" envDefault:"4"`
